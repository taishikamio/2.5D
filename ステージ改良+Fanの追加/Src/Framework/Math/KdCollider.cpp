...
bool KdCollider::Intersects(Type checkType, const DirectX::BoundingSphere& target, std::list<KdCollider::CollisionResult>* pResults)const
{
	bool isHit = false;
...
bool KdCollider::Intersects(Type checkType, const KdCollider::RayInfo& target, std::list<KdCollider::CollisionResult>* pResults)const
{
