...
public:
	...
	bool Intersects(Type checkType, const DirectX::BoundingSphere& target, std::list<KdCollider::CollisionResult>* pResults)const;
	bool Intersects(Type checkType, const KdCollider::RayInfo& target, std::list<KdCollider::CollisionResult>* pResults)const;
