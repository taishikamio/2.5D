...
private:
	...
	//UI関係
	std::unique_ptr<TitleUI> m_pTitleUI = nullptr;
	std::unique_ptr<GameUI>m_pGameUI = nullptr;
	std::unique_ptr<GoalUI>m_pGoalUI = nullptr;
	...
	float m_backAlpha = 0;
	std::unique_ptr<KdTexture>m_pBlackBackTex = nullptr;
